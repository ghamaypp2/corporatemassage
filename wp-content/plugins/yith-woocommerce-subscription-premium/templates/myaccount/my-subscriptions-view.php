...
<?php else: ?>
    <table class="shop_table ywsbs_subscription_table my_account_orders shop_table_responsive">
        ...
        <?php foreach ( $subscriptions as $subscription_post ) :
            ...
            <tr class="ywsbs-item">
                <td class="ywsbs-subscription-product" data-title="<?php _e( 'Product', 'yith-woocommerce-subscription' );?>">
                ...
                <td class="ywsbs-subscription-status" data-title="<?php _e( 'Status', 'yith-woocommerce-subscription' ); ?>">
                    <span class="status <?php echo $subscription->status ?>"><?php echo $status[$subscription->status] ?></span>
                </td>

                <td class="ywsbs-subscription-recurring" data-title="<?php _e( 'Recurring', 'yith-woocommerce-subscription' ); ?>">
                    <?php echo $subscription->get_formatted_recurring() ?>
                </td>

                <td class="ywsbs-subscription-start-date" data-title="<?php _e( 'Start date', 'yith-woocommerce-subscription' ); ?>">
                    <?php echo $start_date ?>
                </td>

                <td class="ywsbs-subscription-payment-date" data-title="<?php _e( 'Next Payment Due Date', 'yith-woocommerce-subscription' ); ?>">
                    <?php echo $next_payment_due_date ?>
                </td>

                <td class="ywsbs-subscription-action-view" data-title="<?php _e( 'View', 'yith-woocommerce-subscription' ); ?>">
                    <?php
                    $actions = array(
                        'view'    => array(
                ...
                <?php if( get_option('ywsbs_allow_customer_cancel_subscription') == 'yes' ): ?>
                    <td class="ywsbs-subscription-action-delete" data-title="<?php _e( 'Cancel', 'yith-woocommerce-subscription' ); ?>">
